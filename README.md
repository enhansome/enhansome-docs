...
A [curated list](https://github.com/testthedocs/awesome-docs) ⭐ 895 | 🐛 9 | 📅 2026-09-25 of awesome documentation tools, guides and good practice.
...
Please take a quick gander at the [contribution guidelines](https://github.com/testthedocs/awesome-docs/blob/master/CONTRIBUTING.md) ⭐ 895 | 🐛 9 | 📅 2026-09-25 first.

Thanks to all [contributors](https://github.com/testthedocs/awesome-docs/graphs/contributors) ⭐ 895 | 🐛 9 | 📅 2026-09-25; you rock!
...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,508 | 🐛 832 | 🌐 TypeScript | 📅 2026-09-25
* [Cortex](https://github.com/cortex-docs/cortex) ⭐ 3,215 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-25 - Generates interactive or static API documentation, typed SDKs, and MCP servers from several API specification formats.
* [widdershins](https://github.com/Mermade/widdershins) ⭐ 1,582 | 🐛 89 | 🌐 JavaScript | 📅 2024-06-04
* [OpenAPI 3 CLI](https://github.com/Redocly/openapi-cli) ⭐ 1,515 | 🐛 163 | 🌐 TypeScript | 📅 2026-09-25
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,620 | 🐛 263 | 🌐 TypeScript | 📅 2026-09-24
* [Agent QA](https://github.com/vostride/agent-qa) ⭐ 887 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - Source-available natural-language browser testing with reusable execution memory, UI recovery, and run artifacts.
...
* [Mark Text](https://github.com/marktext/marktext) ⭐ 61,828 | 🐛 382 | 🌐 TypeScript | 📅 2026-09-25
* [Lapce](https://github.com/lapce/lapce) ⭐ 38,869 | 🐛 905 | 🌐 Rust | 📅 2026-09-25
...
* [relnote](https://github.com/loki-inu/relnote) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-25 - Generate GitHub-flavored release notes from a git range (stdlib Python CLI + Action; conventional-commit grouping).
...
* [wiki](https://github.com/plasma-ai/wiki) ⭐ 102 | 🐛 0 | 🌐 Python | 📅 2026-09-23 - Indexed Markdown knowledge bases for agents, with deterministic indexes, scoped retrieval, linting, and merge handling for parallel edits.
* [reqlan](https://github.com/littletuna4/reqlan) ⭐ 4 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-22 - Semantic requirements as code: a graph of named ideas your agents can search, link, reuse, test and maintain.
...
* [Animockup](https://github.com/alyssaxuu/animockup) ⭐ 1,926 | 🐛 3 | 🌐 JavaScript | 📅 2022-07-02
...
* [lychee](https://github.com/lycheeverse/lychee) ⭐ 3,943 | 🐛 72 | 🌐 Rust | 📅 2026-09-21
...
* [Doc Detective](https://github.com/doc-detective/doc-detective) ⭐ 133 | 🐛 121 | 🌐 TypeScript | 📅 2026-09-15
* [Linkspector](https://github.com/UmbrellaDocs/linkspector) ⭐ 93 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-10
...
* [docproof](https://github.com/melbinjp/docproof) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - Checks whether what documentation claims is still true of the repository: file paths, CLI flags, versions, and documented imports, each resolved against the code and its git history.
* [mdoctest](https://github.com/ingrid-owusu/mdoctest) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-22 - Runs the code blocks and console sessions in Markdown docs and checks their output still matches, with `--fix` to update them; language-agnostic and dependency-free.
...
* [Kap](https://github.com/wulkano/kap) ⭐ 19,374 | 🐛 258 | 🌐 TypeScript | 📅 2024-11-12 (macOS)
* [Screenity](https://github.com/alyssaxuu/screenity) ⭐ 18,728 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-22
...
* [Flameshot](https://github.com/lupoDharkael/flameshot) ⭐ 30,923 | 🐛 731 | 🌐 C++ | 📅 2026-09-17
* [shot-scraper](https://github.com/simonw/shot-scraper) ⭐ 2,581 | 🐛 59 | 🌐 Python | 📅 2026-09-24
* [Heroshot](https://github.com/omachala/heroshot) ⭐ 75 | 🐛 4 | 🌐 TypeScript | 📅 2026-06-28
* [ItsPaint](https://github.com/joshlin2201/itspaint) ⭐ 25 | 🐛 10 | 🌐 Swift | 📅 2026-09-25 (macOS)
* [Carbon](https://carbon.now.sh)
* [Shottr](https://shottr.cc/)

## Site Generators

* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,174 | 🐛 657 | 🌐 Rust | 📅 2026-09-18
* [Nextra](https://github.com/shuding/nextra) ⭐ 13,927 | 🐛 333 | 🌐 TypeScript | 📅 2026-07-31
* [Quartz](https://github.com/jackyzha0/quartz) ⭐ 13,283 | 🐛 80 | 🌐 TypeScript | 📅 2026-09-20
* [Log4brains](https://github.com/thomvaill/log4brains) ⭐ 1,596 | 🐛 57 | 🌐 TypeScript | 📅 2024-12-17
* [VuePress](https://github.com/wevm/vocs/) ⭐ 1,552 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-20
...
* [Nibleaf](https://github.com/lord007tn/nibleaf) ⭐ 6 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-21 - Open-source platform for editing, publishing, searching, and self-hosting multilingual Markdown and MDX documentation.
...
* [Sphinx Substitution Extensions](https://github.com/adamtheturtle/sphinx-substitution-extensions) ⭐ 41 | 🐛 0 | 🌐 Python | 📅 2026-09-25
...
* [Furo](https://github.com/pradyunsg/furo) ⭐ 3,598 | 🐛 52 | 🌐 Sass | 📅 2026-09-21
...
* [GitHub](https://github.com/github/docs/blob/main/contributing/content-style-guide.md#content-style-guide-for-github-docs-) ⭐ 20,892 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-25
...
* [Playwright](https://github.com/microsoft/playwright) ⭐ 96,657 | 🐛 176 | 🌐 TypeScript | 📅 2026-09-25
* [Awesome Design Tools](https://github.com/goabstract/Awesome-Design-Tools) ⭐ 41,315 | 🐛 208 | 🌐 JavaScript | 📅 2024-07-28
* [Driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 26,838 | 🐛 23 | 🌐 TypeScript | 📅 2026-07-18
* [Shepherd](https://github.com/shipshapecode/shepherd) ⭐ 13,816 | 🐛 34 | 🌐 JavaScript | 📅 2026-09-24
* [adr-tools](https://github.com/npryce/adr-tools) ⭐ 5,707 | 🐛 69 | 🌐 Shell | 📅 2024-04-25
* [CodeAlmanac](https://github.com/AlmanacCode/codealmanac) ⭐ 993 | 🐛 52 | 🌐 TypeScript | 📅 2026-07-25 - Self-updating repository wiki for AI coding agents that tracks project conversations and context locally in the repo.
* [docToolchain](https://github.com/doctoolchain/doctoolchain) ⭐ 868 | 🐛 305 | 🌐 Groovy | 📅 2026-09-14
...
* [Glow - Render Markdown on the CLI](https://github.com/charmbracelet/glow) ⭐ 27,463 | 🐛 235 | 🌐 Go | 📅 2026-09-22
